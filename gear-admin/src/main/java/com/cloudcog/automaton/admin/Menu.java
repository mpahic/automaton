...
public class Menu extends CssLayout {
	private static final long serialVersionUID = 340273136961979052L;
	...
	public Menu(String appName, Navigator navigator) {
        ...
        logoutMenu.addItem("Logout", VaadinIcons.SIGN_OUT, new Command() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -215203820856109656L;
        ...
        final Button showMenu = new Button("Menu", new ClickListener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 2094194236460796318L;
